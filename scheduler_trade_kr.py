...
# ----------------------------------------------------------
# 원본 US: TQQQ/BULZ(3x) -15% → 기초 NASDAQ -5% 회복 시점 탈출
# KR: 418660(2x NASDAQ) -10% → 원본 철학(기초지수 -5%) 2x 환산
#     → 공격적 회복 감지 / 조기 V14 복귀 성향
# ==========================================================
_KR_REVERSE_EXIT_THRESHOLD = {
    "418660": -10.0,  # TIGER 미국나스닥100레버리지(2x) — TQQQ -15% 환산
}
_KR_REVERSE_EXIT_DEFAULT = -15.0  # 다른 KR 2x 추가 시 디폴트
